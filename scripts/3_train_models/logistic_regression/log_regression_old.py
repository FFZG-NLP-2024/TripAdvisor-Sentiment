...
joblib.dump(model, 'scripts/3_train_models/logistic_regression/logistic_regression_model.pkl')
joblib.dump(vectorizer, 'scripts/3_train_models/logistic_regression/tfidf_vectorizer.pkl')
