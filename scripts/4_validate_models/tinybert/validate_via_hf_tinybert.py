...
plt.title('Confusion Matrix TinyBERT')
plt.savefig("confusion_matrix_tinybert.png")
plt.show()

# Save results to a CSV file
results_df = pd.DataFrame(results)
results_df.to_csv("validation_results_tinybert.csv", index=False)
print("Results saved to 'validation_results_tinybert.csv'")
